...
class QuizStart:
    def __init__(self, parent):
        ...
        # Adding buttons
        button1=ctk.CTkButton(root, text="Let's Start", bg_color="white", fg_color="#62c370", font=main_font, text_color="white", width=322, height=100, corner_radius=50)
        button2=ctk.CTkButton(root, text="Exit", bg_color="#e46a4a", fg_color="white", font=exit_font, text_color="black", width=100, height=18, corner_radius=8, command=close_window)
